             ...
             <div class="col-lg-4 col-md-6 col-sm-12 wow rrfadeUp mb-4" data-wow-duration=".9s">
                 <div class="rr-service-item text-center mb-30">
                     <div class="rr-service-thumb">
                         <img src="{{ asset($service->image ? 'assets/img/service/' . $service->image : 'assets/img/service/default.jpg') }}" 
                              alt="{{ $service->service }}">
                     </div>
                     <div class="rr-service-content">
                         <h4 class="rr-service-title">
                             <a href="{{ route('frontend.serviceDetails', $service->id) }}">{{ $service->service }}</a>
                         </h4>
                         <p>{{ \Illuminate\Support\Str::limit($service->description, 100) }}</p>
                         <div class="rr-service-btn">
                             <a href="{{ route('frontend.serviceDetails', $service->id) }}">Read More <i class="fa-sharp fa-solid fa-arrow-right"></i></a>
                         </div>
                     </div>
                 </div>
             </div>
